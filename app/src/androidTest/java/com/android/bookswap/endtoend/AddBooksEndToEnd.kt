...
class AddBooksEndToEnd {
    ...
    fun testAddBook() {
        ...
        composeTestRule.onNodeWithTag("description_field").performTextInput("This is a test description for the book.")
        ...
        verify {
            mockBookRepository.addBook(match { book ->
