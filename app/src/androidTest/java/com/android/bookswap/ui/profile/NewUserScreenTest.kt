...
class NewUserScreenTest {
    ...
    fun allComponentsAreDisplayedWithCorrectTexts() {
        composeTestRule.setContent {
            NewUserScreen(navigationActions)
        }
        composeTestRule.onNodeWithTag("welcomeTxt")
            .assertExists()
            .assertIsDisplayed()
            .assertTextEquals("Welcome")

        composeTestRule.onNodeWithTag("personalInfoTxt")
            .assertExists()
            .assertIsDisplayed()
            .assertTextEquals("Please fill in your personal information to start BookSwapping")

        composeTestRule.onNodeWithTag("profilPics")
            .assertExists()
            .assertIsDisplayed()
            .assertHasClickAction()

        composeTestRule.onNodeWithTag("greetingTF")
            .assertExists()
            .assertIsDisplayed()
            .assertTextContains("Greeting")

        composeTestRule.onNodeWithTag("firstnameTF")
            .assertExists()
            .assertIsDisplayed()
            .assertTextContains("Firstname")

        composeTestRule.onNodeWithTag("lastnameTF")
            .assertExists()
            .assertIsDisplayed()
            .assertTextContains("Lastname")

        composeTestRule.onNodeWithTag("emailTF")
            .assertExists()
            .assertIsDisplayed()
            .assertTextContains("Email")

        composeTestRule.onNodeWithTag("phoneTF")
            .assertExists()
            .assertIsDisplayed()
            .assertTextContains("Phone")

        composeTestRule.onNodeWithTag("CreateButton")
            .assertExists()
            .assertIsDisplayed()
