...
class EditProfileScreenTest: TestCase() {
    ...
    @Before
    fun setup(){
        val myAddress = createAddress(
            Locale.UK,
            "dummyAddress",
            HashMap<Int, String>((mapOf(
                (0 to "Example street 1A"),
                (1 to "Apartment 1")))),
            "exampleAdminArea",
            "dummySubAdmin",
            "Foo-Town",
        ...
        composeTestRule.setContent { EditProfileDialog(
            onDismiss = { /*TODO*/ },
            onSave = {Log.d("editUsrAlrt_Save","User info saved ${it.printFull1Line()}")},
            user = User("M.", "John", "Doe", "John.Doe@example.com", "+41223456789", myAddress,"dummyPic.png","dummyUUID0000")
        ) }
    }
