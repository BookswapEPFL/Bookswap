...
object TopLevelDestinations {
    val CHAT = TopLevelDestination(route = Route.CHAT, icon = Icons.Filled.MailOutline, textId = "Chat")
    val MAP = TopLevelDestination(route = Route.MAP, icon = Icons.Outlined.Place, textId = "Map")
    val NEWBOOK = TopLevelDestination(route = Route.NEWBOOK, icon = Icons.Outlined.AddCircle, textId = "New Book")
    val PROFIL = TopLevelDestination(route = Route.PROFIL, icon = Icons.Outlined.AccountCircle, textId = "Profil")
}
/**
 * List of top level destinations that are shown in the bottom navigation bar
 */
val List_Navigation_Bar_Destinations = listOf(TopLevelDestinations.CHAT,TopLevelDestinations.NEWBOOK, TopLevelDestinations.MAP)
