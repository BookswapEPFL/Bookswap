...
fun AddToBookScreen(
  ...
  Scaffold(
      ...
      content = { paddingValues ->
          ...
          Column(modifier = Modifier.background(BackGround).fillMaxWidth().fillMaxHeight()
              .padding(paddingValues),
              verticalArrangement = Arrangement.SpaceBetween){
              // Title Input Field
              FieldComponent(
                  modifier = Modifier.testTag("title_field").fillMaxWidth()
              ...
              FieldComponent(
                  modifier = Modifier.testTag("isbn_field").fillMaxWidth()
                      .padding(horizontal = HORIZONTAL_PADDING.dp), labelText = "ISBN", value = isbn
              ) { isbn = it }
              FieldComponent(
                  modifier = Modifier.testTag("photo_field").fillMaxWidth()
                      .padding(horizontal = HORIZONTAL_PADDING.dp),
                  labelText = "Photo",
                  value = photo
              ) { photo = it }
              FieldComponent(
                  modifier = Modifier.testTag("language_field").fillMaxWidth()
                      .padding(horizontal = HORIZONTAL_PADDING.dp),
                  labelText = "Language*",
                  value = language
              ) { language = it }
