    ...
    LazyColumn(
        ...
        item {
            Card(
                ...
                Column(
                    ...
                    IconButton(onClick = { /*TODO*/ }, modifier = Modifier.size(80.dp).testTag("profilPics")) {
                        Icon(
        ...
        item {
            Box(modifier = Modifier.fillMaxWidth(), contentAlignment = Alignment.Center) {
                Button(
                    onClick = {
                        navigaionActions.navigateTo(Route.MAP)
                    },
