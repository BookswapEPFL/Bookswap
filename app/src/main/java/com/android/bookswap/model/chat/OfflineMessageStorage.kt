...
class OfflineMessageStorage(text: String, private val db: FirebaseFirestore) {
  ...
  private val tempText =
      "C:\\Users\\jaime\\Desktop\\Bookswap\\app\\src\\main\\java\\com\\android\\bookswap\\model\\chat\\Messages.txt"
  ...
  fun retrieveMessagesFromFirestore(callback: (Result<List<DataMessage>>) -> Unit) {
    db.collection("messages")
        ...
        .addOnSuccessListener { textResult ->
          val textMessages =
              textResult.documents.mapNotNull { it.toObject(DataMessage::class.java) }
          ...
          db.collection("messages")
              ...
              .addOnSuccessListener { imageResult ->
                val imageMessages =
                    imageResult.documents.mapNotNull { it.toObject(DataMessage::class.java) }
