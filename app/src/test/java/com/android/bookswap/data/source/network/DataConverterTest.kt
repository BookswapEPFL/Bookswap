...
class DataConverterTest {
  ...
  fun parseRawUUIDList(){
	val bit_uuid_list = List(3,{"{mostSignificantBits=16384, leastSignificantBits=${-4611686018427387904+it}}"})
  ...
  fun convertUUIDListToStringList(){
	...
	assertEquals("UUID list $uuid_list not converted to $str_uuid_list!",str_uuid_list,convrt_uuid_list)
  }
  @Test
  ...
  fun convertLongListToStringList(){
	...
	assertEquals("Value list $raw_long_list not converted to $str_long_list",str_long_list,convrt_long_list)
  }
}