  ...
  fun checkAssign() {
    ...
    fun checkString(){
        ...
        fun createAddress(
            ...
            if(hasLat){addr.latitude = latitude}else{addr.latitude = 0.0}
            if(hasLon){addr.longitude = longitude}else{addr.longitude = 0.0}
            addr.phone = phone
            addr.url = url
        ...
        val userVM = com.android.bookswap.model.UserViewModel("")
        var address = createAddress(Locale.ENGLISH,locality = "Lausanne", postalCode = "1000", countryCode = "CH", countryName = "Switzerland")
        address.setAddressLine(0, "Rue de la Gare 1")
        val usr = User(
            "M.",
            "John",
        ...
        assertEquals("M. John Doe:¦M.|John|Doe¦John.Doe@example.com|+41223456789¦null¦dummyPic.png¦dummyUUID0000",u1.printFull1Line())
        assertEquals("M. John Doe:\n  M.|John|Doe\n  John.Doe@example.com|+41223456789\n  null\n  dummyPic.png\n  dummyUUID0000",u1.printFullMultiLine())
    }
}
